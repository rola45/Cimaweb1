		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li <?php if($uri == 'menu.php') echo "class='active'"; ?>><a href="menu.php">MENU</a>
					<li <?php if($uri == 'carrito.php') echo "class='active'"; ?>><a href="carrito.php">CARRITO</a>
					<li <?php if($uri == 'nosotros.php') echo "class='active'"; ?>><a href="nosotros.php">NOSOTROS</a>
					</li>
					</ul>
